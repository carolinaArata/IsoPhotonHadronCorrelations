...
#IsoGammaHadron(18, 40, "DataSh100_AssocPt500", true, "0.40-1.00", "../FromScratch/checkCode", 1, false, true, TMath::Pi() * 3 / 5, TMath::Pi(), false, false)
#.q
#EOF
##
####
#root -b -l << EOF
#.L ~/work/histogram/FromScratch/PlotIsoGammaHadron.C
#PlotIsoGammaHadron(18, 40,  "../FromScratch/FigcheckCode", "0.40-1.00", "../FromScratch/checkCode")
#.q
#EOF
#----------------------------------------------------------------------------------------------
###############################################################################################
...
#root -b -l <<EOF
#.L ~/work/histogram/FromScratch/IsoGammaHadron.C
#IsoGammaHadron(18, 40, "DataSh100_AssocPt500", true, "0.40-1.00", "../FromScratch/checkCodeSystPur09", 0.9, false, true, TMath::Pi() * 3 / 5, TMath::Pi(), false ,false)
#.q
#EOF
##
#root -b -l <<EOF
#.L ~/work/histogram/FromScratch/IsoGammaHadron.C
#IsoGammaHadron(18, 40, "DataSh100_AssocPt500", true, "0.40-1.00", "../FromScratch/checkCodeSystPur11", 1.1, false, true, TMath::Pi() * 3 / 5, TMath::Pi(), false ,false)
#.q
#EOF
#
#----------------------------------------------------------------------------------------------
...
#root -b -l <<EOF
#.L ~/work/histogram/FromScratch/IsoGammaHadron.C
#IsoGammaHadron(18, 40, "DataSh100_AssocPt500", true, "0.35-1.00", "../FromScratch/checkCodeSytShSh", 1, false, true, TMath::Pi() * 3 / 5, TMath::Pi(), true, false)
#.q
#EOF
##
##
#root -b -l <<EOF
#.L ~/work/histogram/FromScratch/IsoGammaHadron.C
#IsoGammaHadron(18, 40, "DataSh100_AssocPt500", true, "0.40-1.50", "../FromScratch/checkCode/checkCodeSytShSh", 1, false, true, TMath::Pi() * 3 / 5, TMath::Pi(), true, false)
#.q
#EOF
##
##
#root -b -l <<EOF
#.L ~/work/histogram/FromScratch/IsoGammaHadron.C
#IsoGammaHadron(18, 40, "DataSh100_AssocPt500", true, "0.40-2.00", "../FromScratch/checkCode/checkCodeSytShSh", 1, false, true, TMath::Pi() * 3 / 5, TMath::Pi(), true, false)
#.q
#EOF
...
#root -b -l <<EOF
#.L ~/work/histogram/FromScratch/IsoGammaHadron.C
#IsoGammaHadron(18, 40, "DataSh100_AssocPt500", true, "0.40-1.00", "../FromScratch/checkCode/checkCodeTrackEff", 1, false, true, TMath::Pi() * 3 / 5, TMath::Pi(), false, true)
#.q
#EOF
#
